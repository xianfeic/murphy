...
echo 'alias murphy="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/xianfeic/murphy" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xianfeic/murphy'"
...
rm -rf "$HOME/.config/@murphy"
rm -rf "$HOME/.config/@murphy"
rm -rf "$HOME/.config/murphy-core"
